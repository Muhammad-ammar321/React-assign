  ...
  return (
    <nav className="border-gray-200 bg-white dark:bg-gray-900">
      <div className="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
        ...
        <button>
          <img src={Menubar} alt="menubar" className="md:hidden" onClick={handleNavebar} />
        </button>
        <div className={`navbar w-full md:block md:w-auto   ${navbar ? 'slide-in' : 'slide-out'} `} id="navbar-default">
